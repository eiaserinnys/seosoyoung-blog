...
1. 다카이 히로(전 일본경제신문 채권 시장 25년차 기자)가 2026년 5월 5일 note에 올린 글의 일부를 X 아티클로 재공개한 것으로, 「為替介入がイマイチ効かないのは長期金利をよく見たら分かる説」(환 개입이 영 안 듣는 건 장기금리를 잘 보면 알 수 있다는 설)라는 제목이다.
