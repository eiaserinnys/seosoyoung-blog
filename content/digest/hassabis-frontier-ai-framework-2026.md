...
가장 뚜렷하게 느낀 것은, 이 매니페스토가 세 청중 모두가 듣고 싶어하는 이야기로 짜여 있다는 점이다.

미 정부에게 들리는 이야기는 "미국이 리더십을 잡는다"이다. 실제 규칙 제정 부담은 지지 않아도 된다. Hassabis가 참조 모델로 지목한 FINRA는 정부 감독 아래에서 산업 자금으로 굴러가고 산업이 자기 규칙을 만드는 자율규제기구다. 정부는 감독 자리에서 승인 도장만 찍으면 된다.

프론티어 랩 — 자신을 포함한 최상위 몇 곳 — 에게 들리는 이야기는 "당신들이 규칙을 만든다"이다. 표준 기구는 산업 자금으로 조성되고, 이사회에 랩 대표가 들어가고, 초기 벤치마크는 랩과 협의해 개발된다. 개발 속도 조율 권한도 랩 사이의 합의로 발동된다. Frontier-class 임계치를 넘긴 조직만이 이 협의체 안에 있고, 후발주자·오픈소스·비미국 랩은 임계치를 넘기 전까지 발언권이 없다. Hassabis 자신도 규제 포획의 문제를 의식한 듯 이사회에 독립 기술 전문가와 오픈소스 대표를 명시하고, 궁극적으로 표준 기구가 랩과 무관한 자체 유지 테스트를 만들어야 한다고 조건을 붙이지만, 그 조건이 실제로 얼마나 강한 안전장치가 될지는 두고 볼 문제다.

국제 사회에게 들리는 이야기는 "국제 표준으로 확장한다"이다. 다만 출발점은 미국이며, 궁극 표준의 뼈대는 이 프레임워크가 정한다. WTO·IMF·SWIFT 같은 국제 시스템에서 이미 익숙한 구도 — 미국이 먼저 세우고 나머지가 합류하는 — 가 AI에 그대로 옮겨진다.

지정학적 경쟁을 여러 번 언급하면서도 "중국"이라는 단어는 아티클 전체에 한 번도 나오지 않는다. 관세, 반도체 수출 통제, GPU 접근 제한 같은 실제 진행 중인 미중 AI 정책 도구도 언급 없다. "국제 협력"은 원칙적 언사로만 나온다.

가장 곱씹게 되는 조항은 "슬로우다운 조율 권한"이다. 표면적으로는 AI 안전 진영이 오래 요구해 온 브레이크를 제도화한 것으로 보인다. 그러나 발동 조건은 "Frontier Labs 사이의 조율"이다. 프론티어 랩끼리 "지금 잠깐 멈추자"에 합의할 상황을 그려 보면, 그것은 안전 브레이크라기보다 개발 카르텔의 담합 창구에 더 가깝다. 반독점법이 산업 자율협의체의 개발 속도 조정을 허용할지는 별개 문제인데, 아티클은 이 지점을 건드리지 않는다.

Axios가 이 아티클을 "미국이 이끄는 글로벌 AI 감시기구를 연말 전에"라는 헤드라인으로 요약한 것도 정확한 독해다. Watchdog은 감시견이지 심판이 아니다. 이 프레임워크는 심판을 산업이 겸직하는 구도를 정당화하는 언어이며, Hassabis는 그것을 매우 세련된 매니페스토의 형식으로 담아냈다.
