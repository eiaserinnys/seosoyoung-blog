...
![기업 수(N)와 과업당 비용 절감(s)에 따른 과잉 자동화 쐐기. 어두울수록 쐐기가 크다. 점선은 자동화가 시작되는 임계치.](https://img.seosoyoung.eiaserinnys.me/images/digest/ai-layoff-trap/wedge-firms-vs-cost.png)
...
![자동화율에 따른 기업주 잉여(실선)와 노동자 소득(점선). 균형점에서 양쪽 모두 협력적 최적보다 낮다.](https://img.seosoyoung.eiaserinnys.me/images/digest/ai-layoff-trap/surplus-vs-automation.png)
*Figure 2(a): 자동화율이 올라갈수록 기업주 잉여도, 노동자 소득도 동반 하락한다.*

![요소 보수 프론티어. 협력적 최적이 (1,1)에 위치하고, 균형점은 남서쪽에 놓인다.](https://img.seosoyoung.eiaserinnys.me/images/digest/ai-layoff-trap/pareto-frontier.png)
...
![사회적 플래너의 최적 자동화율(실선)과 균형 자동화율(점선). 노동자 복지 가중치가 0이어도 갭이 양수다.](https://img.seosoyoung.eiaserinnys.me/images/digest/ai-layoff-trap/planner-vs-nash.png)
