...
> <strong>· 영상의 화각과 카메라워크에 맞춰, 보여줄 길이를 정한다<br>
> · 컷 점과 화면 안의 움직임, 둘 다로 비트 싱크(音ハメ)를 맞춘다</strong>

*화각*은 이렇게 가른다.

> <strong>· 롱 숏 → 정보량이 많고 시선 이동도 생기므로, 어느 정도 긴 길이가 필요해지기 쉽다<br>
> · 클로즈업 → 정보가 정리돼 있어, 짧은 길이로도 성립하기 쉽다</strong>
...
그리고 결국 *편집*이 가장 많은 시간을 먹는 인간의 작업으로 남는다. 생성이 100본을 토해내도, 컷 길이를 정하고 비트에 맞추고 타임리맵을 거는 일은 여전히 사람의 리듬 감각이다. 도구가 푸는 건 *소재의 양*이고, 사람이 쥐는 건 *순서와 박자*다.
