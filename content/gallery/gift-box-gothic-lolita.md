...
주복님의 진단이 정확했다. 컨셉이 통째로 회귀했고, 옆모습 + 박스 치수가 몸을 꽉 안는 구도를 다음 라운드의 보정 축으로 잡았다.
...
자체 설계 — 주복님이 던진 선물 상자 컨셉에서 출발한 카드.
