...
이 차이를 저는 '숙련을 버렸다'로 읽지 않습니다.[^3] 시스템이 사라진 것도 아닙니다. 시스템의 역할이 바뀌었습니다. 정복하거나 감상할 대상이던 시스템이, 예상하지 못한 사건을 만들어 내는 장치가 됩니다. 밧줄 물리가 어설프면 딸려 내려가는 장면이 나오지 않고, 협력 규칙이 헐거우면 친구를 구하려다 같이 떨어지는 선택이 생기지 않습니다. 실패가 재미가 되려면 실패가 설계되어 있어야 합니다. 이 게임들을 만드는 데 필요한 기술은 줄지 않았습니다. 쓰이는 자리가 옮겨 갔을 뿐입니다.[^4]
...
역할 분담, 정체 추리, 추격, 협동 탈출. 이 넷은 친구끼리 예측하지 못한 상황을 함께 겪는다는 좁은 뜻에서, 친구들과 모여 상황을 겪는 협동 게임, 이 글에서 '소셜 코옵'이라 부를 최근의 스팀 히트작들과 닮은 자리에 있습니다. 저는 이 게임들이 저 게임들의 영향을 받았다고 말하려는 것이 아닙니다. 훨씬 큰 집단이 훨씬 이른 나이에 이미 이 놀이 구조를 대규모로 경험했다는 점을 말하려는 겁니다. 이들에게 '친구와 낯선 상황에 들어가 사건을 겪는다'는 새로 배워야 할 취향이라기보다 이미 몸에 밴 습관입니다.
...
이 표는 나이를 더해 본 산술이지, 실제 이동을 추적한 자료는 아닙니다. 이 산술이 보여 주는 것은 각 집단이 어느 해에 어느 나이에 닿는가뿐입니다. 코로나 이전 성장기의 집단이 먼저 스팀 구매 연령에 닿았고, 코로나기에 훨씬 커진 집단이 지금 그 뒤를 따르고 있습니다. 세대 유입은 완만하지만 집단의 크기는 일정하지 않습니다.[^12] 이것이 소셜 코옵의 흥행이 왜 몇 년 사이에 갑자기 터진 것처럼 보이는지를 제가 설명하는 방식입니다. 집단은 몇 년의 시차를 두고 구매 연령에 닿습니다. 친구가 먼저 산 게임을 함께 고르고, 방송에서 본 장면을 다음 구매로 잇고, 그 습관에 맞는 저렴한 게임이 계속 공급되는 흐름이 겹치면 수요는 한꺼번에 드러납니다.
...
이 질문에 답하려면 시스템은 앞에서 본 대로 더 정교해져야 합니다. 예상하지 못한 사건은 헐거운 규칙에서 나오지 않습니다. 세계관도 두꺼운 설정집보다 친구가 평소와 다른 사람이 되는 낯선 상황 하나로 충분합니다. 둘 다 미리 학습시키는 대상에서 들어가 겪게 하는 장치로 자리를 옮겼을 뿐입니다.
