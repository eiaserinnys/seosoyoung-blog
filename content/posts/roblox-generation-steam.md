...
categories: ["게임"]
summary: "로블록스에서 놀던 아이들이 자라 스팀의 구매자가 되었다. 최근 소셜 코옵의 흥행을 이 가설로 읽습니다. 가장 큰 정황 증거는 놀이의 연속성과 세대의 시차를 겹친 연표입니다."
ShowToc: true
TocOpen: false
sidenotes: true
cover:
...
---
로블록스에서 놀던 아이들이 자라 스팀의 구매자가 되었다. 최근 스팀에서 잇달아 흥행한 소셜 코옵, 이른바 프렌드 슬롭을 저는 이 가설로 읽습니다.[^1] 게이머 전체의 취향이 갑자기 바뀌었다기보다, 취향이 다른 사람들이 상점에 들어왔다는 이야기입니다.

이 세대에게 친구들과 피자 가게를 운영하고, 경찰을 피해 달아나고, 괴물에게 쫓기는 놀이는 새로운 것이 아닙니다. 로블록스 성장기에 초등학생들이 널리 접할 수 있었던 놀이입니다. 2020년에 9세에서 16세였던 집단이 15세 이상이 되는 시기에, 스팀에는 그 놀이와 닮은 게임이 잇따라 나왔습니다.

## 연표가 보여 주는 것

가장 큰 정황 증거는 연표입니다. 로블록스 성장기에 아이들이 하던 게임, 그 아이들의 나이, 스팀 소셜 코옵의 출시를 한 시간축에 겹치면 이렇게 됩니다.[^2]

<figure class="tl-figure" style="margin: 1.5rem 0;">
<style>
.tl { display: grid; grid-template-columns: 44px 78px 1fr; column-gap: 8px; row-gap: 10px; align-items: start; font-size: 14px; line-height: 1.45; }
...
.tl-age { font-size: 13px; color: var(--secondary); padding-top: 8px; line-height: 1.35; }
.tl-age b { color: var(--primary); }
...
<div class="tl" role="table" aria-label="로블록스 성장기의 놀이, 그 아이들의 나이, 스팀 소셜 코옵 출시를 한 시간축에 겹친 연표">
  ...
  <div class="tl-head">2020년에 9-12세 / 13-16세였던 아이들의 나이</div>
  <div class="tl-head">무슨 게임이 나왔고, 무엇을 하며 놀았나</div>
  <div class="tl-year">2008</div><div class="tl-age"></div>
  ...
  <div class="tl-year">2014</div><div class="tl-age"></div>
  ...
  <div class="tl-year">2016</div><div class="tl-age">5-8 / 9-12</div>
  <div class="tl-cards"><div class="tl-card pf"><span class="tag">규모</span>12월 월간 이용자 3,000만 명</div></div>
  <div class="tl-year">2017</div><div class="tl-age">6-9 / 10-13</div>
  ...
  <div class="tl-year">2019</div><div class="tl-age">8-11 / 12-15</div>
  ...
  <div class="tl-year">2020</div><div class="tl-age"><b>9-12 / 13-16</b></div>
  ...
  <div class="tl-year">2023</div><div class="tl-age">12-15 / <b>16-19</b></div>
  ...
  <div class="tl-year">2024</div><div class="tl-age">13-16 / <b>17-20</b></div>
  ...
  <div class="tl-year">2025</div><div class="tl-age">14-17 / <b>18-21</b></div>
  ...
  <div class="tl-year">2026</div><div class="tl-age"><b>15-18</b> / <b>19-22</b></div>
  <div class="tl-cards"><div class="tl-card pf"><span class="tag">지금</span>가운데 열 기준으로 두 집단 모두 15세 이상</div></div>
  <div class="tl-legend">가운데 열은 2020년 상장 서류의 두 연령 구간(당시 이용자의 29%와 13%)에 해를 더하고 뺀 산술입니다. 굵은 글씨는 집단 전체가 15세 이상인 해. 2020년의 같은 연령 구간을 기준으로 각 시점의 나이를 계산한 것이라, 별개의 인구를 더한 것이 아닙니다.</div>
</div>
<figcaption style="font-size: 0.85em; color: var(--secondary); margin-top: 0.5rem;">로블록스 게임의 등장 연도와 스팀 게임의 출시일은 원문과 상점 페이지 기준이며, 놀이 방식 요약은 글쓴이의 것입니다. 개인별 플랫폼 이동이나 게임 사이의 직접 영향 관계를 관측한 자료가 아니라, 이 글이 가장 무겁게 보는 정황 증거입니다.</figcaption>
</figure>

연표에서 이어지는 것은 개별 소재보다 친구들과 즉석에서 사건을 만드는 방식입니다. 역할 분담, 추격, 협동 탈출은 게임에 들어가자마자 함께 벌일 일을 줍니다. 로블록스에서 경찰을 피해 달아나던 놀이와 스팀에서 괴물을 피해 고철을 모으는 놀이는, 친구들과 위험한 상황을 함께 헤쳐 나온다는 점에서 닮았습니다. 규칙을 오래 익힌 뒤에야 재미가 시작되는 게임이라기보다, 들어가자마자 무슨 일이든 벌어지는 게임입니다.

연표는 여기에 세대의 나이를 겹쳐 보여 줍니다. 제일브레이크와 플리 더 퍼실리티가 나온 2017년에 10세에서 13세였던 아이들은, 리썰 컴퍼니가 나온 2023년에 16세에서 19세였습니다. 코로나 붐 때 9세에서 12세였던, 2020년 이용자의 29%를 차지한 더 큰 집단은 R.E.P.O.와 PEAK가 나온 2025년에 14세에서 17세였고, 올해 15세에서 18세가 됩니다.[^3] 이런 놀이를 접하며 자랄 수 있었던 집단이 청소년기 후반에 들어서는 동안, 스팀에는 비슷한 재미를 내세운 게임이 잇따라 나온 셈입니다.

이 둘을 함께 보면, 최근의 흥행을 게이머 전체의 갑작스러운 취향 변화로만 설명할 필요가 없어집니다. 익숙한 놀이를 계속 찾는 세대가 새 구매층으로 합류했다고 읽을 수 있습니다. 여기서 합류는 로블록스를 그만두고 스팀으로 갈아탔다는 뜻이 아닙니다. 로블록스를 계속 하면서 스팀에서 처음으로 유료 게임을 사는 것도, 무료 게임만 하던 스팀 계정으로 만 원짜리 코옵을 결제하기 시작하는 것도 같은 이동입니다.[^4]

## 업계에서 본 같은 이동

연표에서 읽은 세대 이동은 업계 인터뷰와 앞선 예측에도 나타납니다. 시장조사 회사 뉴주의 경영 컨설턴트 로넌 패트릭은 2026년 9월 더 게임 비즈니스 인터뷰에서 "프렌드슬롭은 기본적으로 로블록스가 스팀으로 오는 것"이라고 했습니다. 아주 캐주얼하고, 그래픽 충실도는 낮고, 친구들과 터무니없고 우스운 일을 벌이는 데 무게가 실린 놀이 패턴이 이미 있었고, 그것을 이제 스팀이 받아들이고 있다는 설명입니다. 로블록스 이용자가 자라면서 남는지 떠나는지를 조사했더니 답은 둘 다였고, 나이를 먹어도 이런 사회적 경험을 계속 찾더라고 했습니다.[^5] 연표가 정황으로 보여 주는 것을 그는 이용자 조사 쪽에서 본 셈입니다. 게임 투자자 비니 에를링손도 2025년 11월에 같은 결론을 썼고, 로블록스 개발사 게임팸의 조 페렌츠는 리썰 컴퍼니가 나오기 두 해 반 전인 2021년에 로블록스의 관습이 게임 생태계의 다른 부분으로 퍼질 것이라고 예측했습니다.[^6]

## 게임을 고르는 방식도 함께 온다

합류하는 것은 좋아하는 소재에 그치지 않습니다. 게임을 고르는 방식도 함께 옵니다. 로블록스 이용자는 2020년에 한 달 평균 스무 개가 넘는 서로 다른 경험을 오갔고, 2025년에는 스물네 개를 넘었습니다.[^7] 이 수치는 로블록스 안에서 새 놀이로 자주 옮겨 다녔다는 데까지만 말해 줍니다. 여러 게임을 오가는 것과 한 게임을 오래 하는 것은 얼마든지 함께 갑니다. 그래도 '오늘 친구들과 무엇을 할까'를 고르는 소비에서는 게임 하나가 장기 정착지라기보다 여러 선택지 가운데 하나가 됩니다. 이 습관이 플랫폼 밖의 유료 구매에도 이어지는지는 스팀 쪽 자료와 맞춰 봐야 합니다.

스팀 쪽에서 보이는 모양이 이 해석과 맞습니다. 스팀 마케팅 분석가 크리스 주코프스키가 소셜 코옵 16종의 주간 동시 접속자를 겹쳐 놓고 보니, 상위 게임이 이 장르 이용자의 절반 이상을 차지했다가 몇 달 안에 10%로 내려가고 다음 게임이 그 자리를 채우는 교대가 반복되었습니다. 그는 이 팬층이 두어 달마다 새 게임을 산다고 표현했습니다.[^8] 히트작 사이의 이용자 중복도 큽니다. 2025년 6월 PEAK 이용자의 61%가 R.E.P.O.를 이미 플레이한 것으로 추정됩니다.[^9] 히트작마다 전혀 다른 손님이 생겼다기보다는, 서로 겹치는 팬층이 다음 게임도 함께 산다는 해석에 가깝습니다.
...
같은 이용자들이 비슷한 코옵을 거듭 사는 이유를 물으면, 상품의 중심은 숙련할 규칙보다 친구들과 새로 겪을 상황에 가까워집니다. 귀신 나오는 폐가에서는 평소 침착하던 친구의 비명이, 산에서는 한 사람을 구하려다 모두 추락하는 장면이 구매자가 기대할 법한 사건입니다. 목표 달성에 실패해도 함께 기억할 사건과 웃음이 남으면 플레이 자체가 보상으로 작동합니다. 못하는 시간이 곧 재미에 이르지 못한 시간이었던 게임과는 계산이 다릅니다.

시스템은 이 사건을 만드는 장치입니다. 밧줄과 체력 규칙이 있어야 구하려다 같이 떨어지는 장면이 생기고, 괴물의 추격 규칙이 있어야 누가 먼저 도망쳤는지가 이야기가 됩니다. 이 구매자의 선택에서 시스템은 정복할 대상보다 함께 겪을 사건을 만드는 장치로 먼저 평가받습니다.[^11]

## 기획이 달라지는 지점

이 구매자에게 팔 게임을 기획한다면 먼저 답할 질문이 바뀝니다. 어떤 장르이고 어떤 세계이며 어떤 시스템이 있는가보다, 오늘 친구들과 들어가면 무슨 일이 벌어지는가입니다. 이 질문은 소개 문구를 바꾸는 일로 끝나지 않습니다. 목표를 이루지 못한 판에서도 친구들과 겪은 사건이 보상이 되어야 하고, 게임은 그런 사건을 한 번의 우연으로 끝내지 않고 판마다 새로 만들어 줄 수 있어야 합니다. 실패의 비용을 낮추고, 실패가 웃음이 되는 물리와 규칙을 넣고, 친구가 평소와 다른 모습을 보일 상황을 설계하는 일입니다. 친구들과 들어가자마자 사건이 시작되어야 하므로, 세계관도 사전 학습보다 플레이 속 경험으로 전달해야 합니다.[^12] 따라서 기획은 시스템의 깊이만큼, 친구들과 어떤 사건을 판마다 만들어 주는지도 상품 가치로 설명해야 합니다.
...
[^3]: 출시일은 스팀 상점 페이지 기준(파스모포비아 2020-09-18, 리썰 컴퍼니 2023-10-23, 콘텐츠 워닝 2024-04-01, R.E.P.O. 2025-02-26, PEAK 2025-06-16). 연표 가운데 열은 2020년 상장 서류의 두 연령 구간에 해를 더하고 뺀 산술이며, 굵은 글씨의 기준인 15세는 성인 연령이라기보다 만 원 안팎의 게임을 직접 고르기 시작하는 나이로 잡은 것입니다. 로블록스는 2026년 연령 검증 뒤 실제 연령이 자기 신고보다 어렸다고 밝혔으므로([Q4 2025 Shareholder Letter](https://www.sec.gov/Archives/edgar/data/1315098/000131509826000009/ex991-q42025shareholder.htm)), 산술은 표보다 한두 해 늦어질 수 있습니다. 이 점은 가설의 시점을 앞당기기보다 늦추는 쪽으로 작용합니다. 특정 게임을 실제로 즐긴 사람들이 이후 스팀에서 구매했다는 관측은 없으며, 연표는 놀이 방식의 연속성과 시차를 보여 주는 정황 증거입니다.

[^4]: 로블록스의 하루 이용자는 2025년 4분기 1억 4,400만 명으로 계속 늘었습니다(앞의 Q4 2025 Shareholder Letter). 이 성장과 가설은 충돌하지 않습니다. 이주를 로블록스 이탈로 좁게 정의하면 자료가 없지만, 병행과 유료 구매 시작까지 포함하면 스팀 쪽의 구매 행동 자료(각주 8, 7)가 간접 증거가 됩니다.
...
[^7]: 2020년 수치는 앞의 S-1(하루 이용자 1인당 하루 2.6시간, 월 20개 이상의 경험), 2025년 수치는 앞의 Q4 2025 Shareholder Letter(월 24개 이상).
