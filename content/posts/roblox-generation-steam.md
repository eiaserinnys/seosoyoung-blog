...
이 차이를 저는 '숙련을 버렸다'로 읽지 않습니다.[^3] 시스템이 사라진 것도 아닙니다. 시스템의 역할이 바뀐 것입니다. 정복하거나 감상할 대상이던 시스템이, 예상하지 못한 사건을 만들어 내는 장치가 됩니다. 밧줄 물리가 어설프면 딸려 내려가는 장면이 나오지 않고, 협력 규칙이 헐거우면 친구를 구하려다 같이 떨어지는 선택이 생기지 않습니다. 실패가 재미가 되려면 실패가 설계되어 있어야 합니다. 이 게임들을 만드는 데 필요한 기술은 줄지 않았습니다. 쓰이는 자리가 옮겨 갔을 뿐입니다.[^4]
...
그때 이 아이들이 무엇을 하고 놀았는지도 기록이 있습니다. 2019년 말 기준으로 누적 방문 10억 회를 넘긴 로블록스 게임 열 개를 보면, 2008년에 나온 '피자 가게에서 일하기'는 요리사와 배달원과 계산원으로 역할을 나눠 가게를 굴리는 놀이였고, 2014년의 '머더 미스터리 2'는 살인자와 보안관과 시민으로 나뉘어 서로의 정체를 추리하며 쫓고 쫓기는 놀이였습니다. 2017년의 '제일브레이크'는 탈옥과 강도와 경찰 추격이었고, 같은 해의 '플리 더 퍼실리티'는 추격자를 피해 협동으로 탈출하는 놀이였습니다.[^8]

역할 분담, 정체 추리, 추격, 협동 탈출. 이 목록을 2025년 스팀의 소셜 코옵 히트작 옆에 놓으면 문법이 겹칩니다. 저는 이 게임들이 저 게임들의 영향을 받았다고 말하려는 것이 아닙니다. 훨씬 큰 집단이 훨씬 이른 나이에 이미 이 놀이 구조를 대규모로 경험했다는 점을 말하려는 것입니다. 이들에게 '친구와 낯선 상황에 들어가 사건을 겪는다'는 새로 배워야 할 취향이라기보다 이미 몸에 밴 습관입니다.
...
<svg viewBox="0 0 420 592" width="100%" role="img" aria-labelledby="cohort-title cohort-desc" style="display:block; max-width: 560px; margin: 0 auto; font-family: inherit;">
  ...
  <desc id="cohort-desc">2017년에 9세에서 12세였던 집단, 2020년에 9세에서 12세였던 집단, 2020년에 13세에서 16세였던 집단이 2026년까지 해마다 몇 살이 되는지를 세로 타임라인으로 보여 준다. 왼쪽에는 파스모포비아(2020년 9월), 리썰 컴퍼니(2023년 10월), 콘텐츠 워닝(2024년 4월), R.E.P.O.(2025년 2월), PEAK(2025년 6월)의 스팀 출시 시점을 표시했다. 굵은 글씨는 연령 하한이 18세 이상인 해다.</desc>
  <style>
  ...
  <!-- 레인 테두리 -->
  <rect class="cf-lane" x="158" y="96" width="84" height="464" rx="6"/>
  ...
  <text class="cf-yr" x="8" y="590">굵은 글씨: 연령 하한이 18세 이상인 해. 회색 띠: 스팀 소셜 코옵 주요 출시 연도.</text>
</svg>
<figcaption style="font-size: 0.85em; color: var(--secondary); margin-top: 0.5rem;">로블록스 상장 서류의 연령 구간에 해를 더한 산술입니다. 실제 이동률이나 잔존율을 측정한 자료가 아니며, 2017년 집단은 그해에 그 나이였다고 가정한 예시입니다. 출시일은 스팀 상점 페이지 기준.</figcaption>
</figure>

2017년에 9세에서 12세였던 아이는 2023년에 15세에서 18세, 2025년에 17세에서 20세, 2026년에 18세에서 21세가 됩니다. 2020년에 9세에서 12세였던 아이는 2026년에 15세에서 18세, 같은 해 13세에서 16세였던 아이는 2026년에 19세에서 22세입니다. 스팀 소셜 코옵의 최근 파도를 연 '리썰 컴퍼니'가 2023년 10월, 'R.E.P.O.'가 2025년 2월, 'PEAK'가 2025년 6월에 나왔습니다.[^11]

이 표는 나이를 더해 본 산술이지, 실제 이동을 추적한 자료는 아닙니다. 그래도 한 가지는 분명히 보여 줍니다. 코로나 이전 성장기의 집단이 먼저 스팀 구매 연령에 도달했고, 코로나기에 훨씬 커진 집단이 지금 그 뒤를 따르고 있습니다. 세대 유입은 완만하지만 집단의 크기는 일정하지 않습니다.[^12] 이것이 소셜 코옵의 흥행이 왜 몇 년 사이에 갑자기 비선형으로 보이는지를 제가 설명하는 방식입니다. 점진적으로 자란 집단이 몇 년의 시차를 두고 구매 연령에 이르고, 친구 집단의 공동 구매와 스트리밍이라는 발견 채널과 그 습관에 딱 맞는 저렴한 상품 공급이 겹치면서 발현이 증폭됩니다.

여기서 '이주'라는 말을 조심스럽게 정의해 두고 싶습니다. 로블록스를 떠나 스팀에 새로 가입하는 것만이 이주가 아닙니다. 이미 스팀에 계정은 있었지만 무료 게임만 하던 이용자가 유료 코옵을 사기 시작하는 것, 로블록스와 스팀을 병행하는 것 모두 수요의 이동입니다. 로블록스의 하루 이용자가 2025년 4분기에 1억 4,400만 명으로 도리어 크게 늘어난 것은 이 가설과 충돌하지 않습니다.[^13] 스팀 히트작 사이의 이용자 중복도 마찬가지입니다. 2025년 6월 PEAK 이용자의 61%가 R.E.P.O.를, 약 40%가 '콘텐츠 워닝'을 이미 플레이한 것으로 추정됐습니다.[^14] 히트작마다 새 집단이 생겼다기보다 같은 집단이 다음 경험으로 옮겨 가고 있습니다. 한 달에 스무 개를 오가던 그 리듬 그대로입니다.
...
개발사 대표, 투자자, 기자, 시장조사 컨설턴트. 서 있는 자리가 다른 네 사람이 다섯 해에 걸쳐 같은 것을 보았습니다. 이것이 통계적 증명은 아닙니다. 그래도 저는 서로 다른 자리에서 같은 답이 나오는 장면을 가볍게 넘기지 못합니다.[^19]
...
이 질문에 답하려면 시스템은 더 정교해져야 합니다. 예상하지 못한 사건은 헐거운 규칙에서 나오지 않습니다. 물리가 정확해야 우스운 낙하가 나오고, 협력 규칙이 촘촘해야 배신과 구조의 선택이 생기고, 실패의 비용이 설계되어 있어야 실패가 이야기가 됩니다. 시스템은 정복 대상에서 사건 생성 장치로 자리를 옮겼을 뿐 덜 중요해지지 않았습니다.

세계관도 그렇습니다. 설정집이 두꺼워야 세계가 깊은 것이 아닙니다. 낯선 상황이 하나만 있어도, 그 안에서 친구가 평소와 다른 사람이 되는 장면이 나온다면 그 세계는 이미 충분히 깊습니다. 세계관은 미리 학습시키는 대상에서 들어가서 겪게 하는 대상으로 바뀝니다.
...
[^2]: 이 글의 판단은 통계적 검정이라기보다 베이지안 방식의 작업 가설 채택입니다. 이 글의 바탕이 된 논의에서 잠정적으로 잡은 주관적 확신은 이렇습니다. 로블록스 성장 세대가 의미 있는 규모로 스팀 유료 구매층에 합류했다 약 85%, 그 유입이 스팀 소셜 코옵 확대의 주요 원인 중 하나다 약 80%(연령 시차 검토 뒤 70%였다가 선행 업계 분석을 확인하고 80%로 올렸습니다), 신규 PC 게임 선택에서 참여할 상황의 상대적 비중이 커졌다 약 85%, 스팀 시장 전체의 단절적 전환을 설명하는 지배적 원인이다 약 35%. 이 숫자는 논의 기록의 잠정값이지 어떤 기관의 발표도 아니고, 같은 현상을 본 분석자들의 의견을 독립 표본처럼 곱해서 얻은 값도 아닙니다.
