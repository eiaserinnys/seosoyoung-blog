...
cover:
  image: "/images/library-storyboard/11-seal-burst.png"
---
...
*거울 속의 불꽃*은 엠버 앤 블레이드의 VN 프리퀄 시놉시스다. 서소영이 주인공이고, 동방의 세도가에서 비밀 임무를 띠고 서양 마법 학교에 유학 온 설정이다.
...
이 경험에서 발견한 무상태 병목은 이미지 생성에만 국한된 문제가 아닐 것이다. 영상 생성 AI가 씬 단위로 발전하더라도, 씬과 씬 사이의 연속성 — 인물이 입은 옷의 손상 상태, 조명의 시간대 변화, 감정선의 축적 — 은 여전히 모델 바깥에서 관리해야 할 상태다. AI 창작 도구의 다음 도약은 개별 생성물의 품질이 아니라, 생성물 사이의 상태를 관리하는 레이어에서 일어날 거라고 생각한다.
